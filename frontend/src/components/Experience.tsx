    ...
    <section id='experience' className='mt-10 max-w-5xl mx-auto'>
      ...
      <div className='md:grid md:grid-cols-2 md:gap-12 my-10 md:my-20'>
        <div className='text-center md:text-left col-span-1'>
          <p>
            Mitt intresse för programmering startade på min tidigare arbetsplats
            där jag jobbade som <strong>marknadsprojektledare</strong>. I
            klassisk litet marknadsteam-anda hade jag ett flertal roller, bland
            annat grafisk designer. I samband med ett nytt utvecklingsprojekt
            blev jag tilldelad rollen som inhouse UI-designer.
          </p>
        </div>
        <div className='text-center md:text-left col-span-1'>
          <p>
            Jag hade en aktiv roll att hjälpa frontend utvecklarna att ta fram
            en användbar <strong>UI-design</strong> för en AI-molntjänstservice
            inom hissbranschen. På den vägen föddes mitt intresse för
            programmering som ett år senare ledde mig till att bli en
            Fullstack-webbutvecklingsstudent hos <strong>Chas Academy</strong>.
          </p>
        </div>
      </div>
    </section>
